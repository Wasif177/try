...
def action():
    ...
    jalan ("\033[1;95mTotal 8 password will clone ≋_≋_≋_≋_≋_≋_≋_≋_≋_≋_≋_≋ ali124  , khan123, khan786, sha123, pti123 password Start Cracking...")
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Wasif Process Has Been Completed▰▱▰▱▰▱▰▱▰▱...100%'
